...
function getTransporter() {
  ...
  return nodemailer.createTransport({
    ...
    connectionTimeout: 4000, // fail fast (4 seconds) if connection hangs
...
async function sendRegistrationOtp(to, otp) {
  ...
  try {
    ...
    t.close(); // Close active connection pool sockets so the serverless function can return immediately!
  }
}
